...
export const getAllScores = (): Array<[number, number, string]> => {
...
export const checkScore = (game: TennisGame, player1Score: number, player2Score: number, expectedScore: string): void => {
